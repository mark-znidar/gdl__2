...
def set_cfg_posenc(cfg):
    ...
    # Config for Learnable HKS (LHKS) specific options.
    cfg.posenc_LHKS.kernel_times = 16
    cfg.posenc_LHKS.num_eigvec = 8
    cfg.posenc_LHKS.learn_times = True
    cfg.posenc_LHKS.freeze_times = False
